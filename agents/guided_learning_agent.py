...
try:
    ...
    MCP_AVAILABLE = False
    # No direct tool import needed here as we just skip OCR/Audio if MCP missing
...
def run_guided_learning(
    ...
    if image:
        if MCP_AVAILABLE:
            ...
            print("MCP not available, skipping OCR.")
        ...
        if MCP_AVAILABLE:
            ...
            print("MCP not available, skipping Audio transcription.")
